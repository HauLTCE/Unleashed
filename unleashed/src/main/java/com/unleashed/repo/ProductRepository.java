...
//    Page<Object[]> searchProducts(@Param("query") String query, Pageable pageable);
    ...
    @Query("""
            ...
            """)
    List<Object[]> findRawCategoryDataForProductIds(@Param("productIds") Set<String> productIds);


    default Map<String, List<String>> findCategoryNamesMapByProductIds(Set<String> productIds) {
